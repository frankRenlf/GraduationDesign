...
<template>
    <Modal v-model="showModal" draggable sticky :reset-drag-position="true" :mask="false" :width="800" title="导出图片"
        ...
        <div style="position: relative;height: 400px;">
            ...
            <Row :gutter="5">
                ...
                <RadioGroup v-model="border" @on-change="onChange">
                    <Radio label="一寸" border></Radio>
                    <Radio label="二寸" border></Radio>
                    <Radio label="小一" border></Radio>
                    <Radio label="大一" border></Radio>
                </RadioGroup>
                <canvas ref="ab" width="200" height="280" id="abb" style="display: none;"/>
                </Col>
